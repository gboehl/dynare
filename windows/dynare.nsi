...
Section "MEX files for MATLAB 64-bit, version 9.4 to 9.12 (R2018a to R2022a)"
 SetOutPath $INSTDIR\mex\matlab\win64-9.4-9.12
 File ..\mex\matlab\win64-9.4-9.12\*.mexw64
SectionEnd
...
Section "MEX files for Octave 7.2.0 (64-bit)"
