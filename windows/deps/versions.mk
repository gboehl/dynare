...
MINGW64_MATIO_VERSION = 1.5.19-1
...
MINGW64_GCC_VERSION = 10.2.0-9

# pacman -Ss mingw-w64-x86_64-gmp
MINGW64_GMP_VERSION = 6.2.1-1

# pacman -Ss mingw-w64-x86_64-binutils
MINGW64_BINUTILS_VERSION = 2.36.1-1

# pacman -Ss mingw-w64-x86_64-headers-git
MINGW64_HEADERS_VERSION = 9.0.0.6128.07922837-2

# pacman -Ss mingw-w64-x86_64-crt-git
MINGW64_CRT_VERSION = 9.0.0.6128.07922837-1

# pacman -Ss mingw-w64-x86_64-winpthreads-git
MINGW64_WINPTHREADS_VERSION = 9.0.0.6128.07922837-2

# pacman -Ss mingw-w64-x86_64-zstd
MINGW64_ZSTD_VERSION = 1.4.8-2
